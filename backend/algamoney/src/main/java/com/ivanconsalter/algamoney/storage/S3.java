package com.ivanconsalter.algamoney.storage;
...
public class S3 {
	...
	public String salvarTemporariamente(MultipartFile arquivo) {
		...
		try {
			PutObjectRequest putObjectRequest = new PutObjectRequest(algamoneyApiProperty.getS3().getBucket(),
					nomeUnico, arquivo.getInputStream(), objectMetadata).withAccessControlList(accessControlList);
	...
	public void salvar(String objeto) {
		SetObjectTaggingRequest setObjectTaggingRequest = new SetObjectTaggingRequest(
				algamoneyApiProperty.getS3().getBucket(), objeto, new ObjectTagging(Collections.emptyList()));

		amazonS3.setObjectTagging(setObjectTaggingRequest);
	}

	public void remover(String objeto) {
		DeleteObjectRequest deleteObjectRequest = new DeleteObjectRequest(algamoneyApiProperty.getS3().getBucket(),
				objeto);

		amazonS3.deleteObject(deleteObjectRequest);
	}

	public void substituirAnexo(String objetoAntigo, String objetoNovo) {
